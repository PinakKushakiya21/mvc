                        ...
                        <div class="price-container info-container m-t-30">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    ...
                                    <div class="price-box">
                                        <span class="price">$<?php echo ($product['price'] - $discount); ?></span>
                                        <span class="price-strike">$<?php echo $product['price']; ?></span>
                                    </div>
                                    <div class="price-box">
                                        <h5><b>You Save: $<?php echo $discount; ?> (<?php echo $product['discount']; ?>%)</b></h5>
                                    </div>
                                </div>
        ...
        <section class="section featured-product">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="ad-imgs">
                        <img class="img-responsive" src="./Skin/customer/assets/images/banners/home-banner1.jpg" alt="">
                        <img class="img-responsive" src="./Skin/customer/assets/images/banners/home-banner2.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-9">
                            ...
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="./Skin/customer/assets/images/products/p1.jpg" alt=""></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="./Skin/customer/assets/images/products/p2.jpg" alt=""></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="./Skin/customer/assets/images/products/p3.jpg" alt=""></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="./Skin/customer/assets/images/products/p4.jpg" alt=""></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="./Skin/customer/assets/images/blank.gif" data-echo="./Skin/customer/assets/images/products/p5.jpg" alt=""></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="./Skin/customer/assets/images/blank.gif" data-echo="./Skin/customer/assets/images/products/p6.jpg" alt=""></a>
                                        </div>
                                        <!-- /.image -->
