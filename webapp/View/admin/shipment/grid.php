...
<body>
    <div class="row">
         ...
         <a href="<?php echo $this->getUrl()->getUrl('form'); ?>" class="btn btn-primary pink" name="update">Add Shipping
    ...
    <div class="container-fluid">
        <div class="card text-left">
          <div class="card-body">
            ...
            <tbody>
            <?php
                $data = $this->getPaginationShipments();  // line add for pagination
            ...
            ?>
            <tr id="txtData">
                <td><?php echo $record->methodId ?></td>
                ...
                <th>
                    <a href="<?php echo $this->getUrl()->getUrl('changeStatus',NULL,['id'=>$record->methodId,'status'=>$record->status],true);?>" class="btn btn-secondary orange">
                ...
                <th><a href="<?php echo $this->getUrl()->getUrl('form',NULL,['id'=>$record->methodId]); ?>" class="btn btn-warning yellow">edit</a></th>
                <th><a href="<?php echo $this->getUrl()->getUrl('delete',NULL,['id'=>$record->methodId]); ?>" class="btn btn-danger red">delete</a></th>
