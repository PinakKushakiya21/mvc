...
<body>
    <div class="row">
        <div class="input-field col s12">
            <a href="<?php echo $this->getUrl()->getUrl('form'); ?>" class="btn btn-primary pink" name="update">Add
                Customer
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <table class="highlight">
                    ...
                    <tbody>
                        <?php
                        $data = $this->getPaginationCustomers();  // line add for pagination
            ...
            ?>
                    ...
                    ?>
                            ...
                            <th>
                                <a href="<?php echo $this->getUrl()->getUrl('changeStatus',NULL,['id'=>$record->customerId,'status'=>$record->status],true);?>"
                            ...
                            <th><a href="<?php echo $this->getUrl()->getUrl('form',NULL,['id'=>$record->customerId]); ?>"
                                    class="btn btn-warning yellow">edit</a></th>
                            <th><a href="<?php echo $this->getUrl()->getUrl('delete',NULL,['id'=>$record->customerId]); ?>"
