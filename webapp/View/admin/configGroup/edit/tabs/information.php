        ...
        <div class="card-body">
            ...
            <form action="<?php echo $this->getUrl()->getUrl('save'); ?>" method="post">
                        ...
                        <?php if ($this->getRequest()->getGet('id')):  ?>
                            <p class="h2 text-center">Update ConfigGroup Details</p><br>
                        <?php else: ?>
                            <p class="h2 text-center">Add ConfigGroup Details</p><br>
                        <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="name">ConfigGroup Name</label>
                            <input id="name" name="configGroup[name]" value="<?php echo $configGroup->name ?>" type="text" class="validate form-control" require>
                        </div>
                        ...
                        <!-- <div class="form-group col-md-6">
                            ...
                            <input id="code" name="configGroup[code]" value="<?php //echo $configGroup->code ?>" type="text" class="validate form-control" require>
                        </div>
                        
                        <div class="form-group col-md-6">
                            <label for="code">Value</label>
                            <input id="code" name="configGroup[value]" value="<?php //echo $configGroup->value ?>" type="text" class="validate form-control" require>
                        </div> -->
                    ...
                    <?php if (!$this->getRequest()->getGet('id')):  ?>
                        ...
                        <button class="btn btn-primary" type="submit" name="add">Add ConfigGroup
                            
                        </button>
                    <?php  else: ?>
                        <button class="btn btn-warning" type="submit" name="add">Update ConfigGroup
